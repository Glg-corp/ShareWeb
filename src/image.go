...
func compareImage(path1 string, path2 string) (bool, string) {
    ...
    fmt.Println("The two images have a resemblance of", math.Round(float64(nbPixelsEquivalent) / float64(counter)*100 * 100)/100, "%")
